...
public:
    ...
    float _tilt_wheel_left_gw=0;  // -1..1
    float _tilt_wheel_right_gw=0;  // -1..1
    float get_tilt_wheel_left_gw(){return _tilt_wheel_left_gw;}
    float get_tilt_wheel_right_gw(){return _tilt_wheel_right_gw;}
