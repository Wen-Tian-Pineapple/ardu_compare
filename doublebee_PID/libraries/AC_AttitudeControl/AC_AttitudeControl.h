...
public:
    ...
    float jai_desired_u=0;
    float jai_thrust_out=0;
    int jai_thrust_state=0;
    float _desired_pitch_angle_rad=0;
    float _desired_pitch_angle_rate_rad=0;
    float _desired_pitch_angle_rate_dot=0;

    float _wheel_rate_r=0;
    float _wheel_rate_l=0;
    float _wheel_command_r=0;
    float _wheel_command_l=0;

    float _beta_command=0;
    float _thr_out_command=0;
