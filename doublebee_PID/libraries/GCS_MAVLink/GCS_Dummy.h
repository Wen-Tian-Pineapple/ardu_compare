...
protected:
    ...
    Vector3f get_state_JAI() override{return Vector3f(0,0,0);};
    Vector3f get_state_JAI_2() override{return Vector3f(0,0,0);};
    Vector3f get_state_JAI_3() override{return Vector3f(0,0,0);};
