...
static void mavlink_test_jai_raw(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_JAI_RAW >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_jai_raw_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0
    };
    mavlink_jai_raw_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.rol = packet_in.rol;
        packet1.pit = packet_in.pit;
        packet1.yaw = packet_in.yaw;
        packet1.drol = packet_in.drol;
        packet1.dpit = packet_in.dpit;
        packet1.dyaw = packet_in.dyaw;
        packet1.xa = packet_in.xa;
        packet1.ya = packet_in.ya;
        packet1.za = packet_in.za;
        packet1.ur = packet_in.ur;
        packet1.ul = packet_in.ul;
        packet1.disired_pit = packet_in.disired_pit;
        packet1.desired_dpit = packet_in.desired_dpit;
        packet1.beta = packet_in.beta;
        packet1.Thr_out = packet_in.Thr_out;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_JAI_RAW_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_JAI_RAW_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_raw_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_jai_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_raw_pack(system_id, component_id, &msg , packet1.time_usec , packet1.rol , packet1.pit , packet1.yaw , packet1.drol , packet1.dpit , packet1.dyaw , packet1.xa , packet1.ya , packet1.za , packet1.ur , packet1.ul , packet1.disired_pit , packet1.desired_dpit , packet1.beta , packet1.Thr_out );
    mavlink_msg_jai_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_raw_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.rol , packet1.pit , packet1.yaw , packet1.drol , packet1.dpit , packet1.dyaw , packet1.xa , packet1.ya , packet1.za , packet1.ur , packet1.ul , packet1.disired_pit , packet1.desired_dpit , packet1.beta , packet1.Thr_out );
    mavlink_msg_jai_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_jai_raw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_raw_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.rol , packet1.pit , packet1.yaw , packet1.drol , packet1.dpit , packet1.dyaw , packet1.xa , packet1.ya , packet1.za , packet1.ur , packet1.ul , packet1.disired_pit , packet1.desired_dpit , packet1.beta , packet1.Thr_out );
    mavlink_msg_jai_raw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("JAI_RAW") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_JAI_RAW) != NULL);
#endif
}

static void mavlink_test_jai_out(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_JAI_OUT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_jai_out_t packet_in = {
        17.0,45.0,73.0,17859,175
    };
    mavlink_jai_out_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.wh_r = packet_in.wh_r;
        packet1.wh_l = packet_in.wh_l;
        packet1.u_thr = packet_in.u_thr;
        packet1.pit_pwm = packet_in.pit_pwm;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_JAI_OUT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_JAI_OUT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_out_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_jai_out_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_out_pack(system_id, component_id, &msg , packet1.rc_state , packet1.pit_pwm , packet1.wh_r , packet1.wh_l , packet1.u_thr );
    mavlink_msg_jai_out_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_out_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rc_state , packet1.pit_pwm , packet1.wh_r , packet1.wh_l , packet1.u_thr );
    mavlink_msg_jai_out_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_jai_out_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_jai_out_send(MAVLINK_COMM_1 , packet1.rc_state , packet1.pit_pwm , packet1.wh_r , packet1.wh_l , packet1.u_thr );
    mavlink_msg_jai_out_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("JAI_OUT") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_JAI_OUT) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_jai_raw(system_id, component_id, last_msg);
    mavlink_test_jai_out(system_id, component_id, last_msg);
}
