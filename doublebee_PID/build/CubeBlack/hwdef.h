...
#define CHIBIOS_BOARD_NAME "CubeBlack"
...
#define HAL_SPI_DEVICE20 SPIDesc("icm20948_ext"   ,  2,  1, PAL_LINE(GPIOE,4U) , SPIDEV_MODE3,   4*MHZ,   8*MHZ)
#define HAL_SPI_DEVICE21 SPIDesc("icm20602_ext"   ,  2,  3, PAL_LINE(GPIOC,13U), SPIDEV_MODE3,   4*MHZ,   8*MHZ)
...
{  8,    3.30/4096 }, /* PB0 PB0_ADC */ \
{  9,    3.30/4096 }, /* PB1 PB1_ADC */ \
...
#define HAL_GPIO_PIN_PB0_ADC              PAL_LINE(GPIOB,0U)
#define HAL_GPIO_PIN_PB1_ADC              PAL_LINE(GPIOB,1U)
...
#define HAL_VALIDATE_BOARD (!((spi_check_register("mpu9250_ext", MPUREG_WHOAMI, MPU_WHOAMI_MPU9250)) || (spi_check_register("icm20602_ext", MPUREG_WHOAMI, MPU_WHOAMI_ICM20602)))?"$CHECK_IMU0_PRESENT":!(((spi_check_register("lsm9ds0_ext_g", LSMREG_WHOAMI, LSM_WHOAMI_L3GD20)) && (spi_check_register("lsm9ds0_ext_am", LSMREG_WHOAMI, LSM_WHOAMI_LSM303D))) || (spi_check_register("icm20948_ext", INV2REG_WHOAMI, INV2_WHOAMI_ICM20948)))?"$CHECK_IMU1_PRESENT":!((spi_check_register("mpu9250", MPUREG_WHOAMI, MPU_WHOAMI_MPU9250)))?"$CHECK_IMU2_PRESENT":!((check_ms5611("ms5611")))?"$CHECK_BARO0_PRESENT":!((check_ms5611("ms5611_ext")))?"$CHECK_BARO1_PRESENT":nullptr)
...
#define HAL_USB_PRODUCT_ID 0x1011
...
/* PORTB:
 PB0 PB0_ADC ADC1 ADC1_IN8
 PB1 PB1_ADC ADC1 ADC1_IN9
 PB2 BOOT1 INPUT
 PB3 FMU_SW0 INPUT
